    ...
    return (
        <>
            ...
            <section className="subpage-hero" style={{ position: 'relative', overflow: 'hidden' }}>
                {/* SVG Circuit Lines */}
                <svg className="hero-circuit-svg" viewBox="0 0 900 500" preserveAspectRatio="xMidYMid slice" aria-hidden="true">
                    <path className="circuit-path" d="M0,100 L200,100 L200,200 L400,200 L400,80 L700,80" />
                    <path className="circuit-path" d="M900,300 L600,300 L600,180 L350,180 L350,350 L100,350" />
                    <path className="circuit-path-2" d="M50,450 L300,450 L300,320 L550,320 L550,420 L850,420" />
                    <circle cx="200" cy="100" r="4" fill="#6366f1" opacity="0.5" />
                    <circle cx="400" cy="200" r="4" fill="#a855f7" opacity="0.5" />
                    <circle cx="600" cy="300" r="4" fill="#6366f1" opacity="0.5" />
                    <circle cx="350" cy="180" r="4" fill="#a855f7" opacity="0.5" />
                </svg>
                {/* Floating Orbs */}
                ...
                <div className="container hero-container" style={{ position: 'relative', zIndex: '2' }}>
                    <div className="hero-content">
                        <span className="badge-accent">⚡ AI AUTOMATION SERVICES</span>
                        <h1 className="hero-heading reveal" style={{ fontSize: 'clamp(28px, 3.5vw, 46px)' }}>
                            Powerful AI Services Built To
                            <span className="gradient-text-purple" data-typed-text={"Automate Modern\nBusinesses"} data-typed-delay="400" style={{ whiteSpace: 'pre-wrap' }}> Automate Modern{"\n"}Businesses</span>
                        </h1>
                        <p className="hero-description reveal reveal-delay-1">
                            We help businesses automate customer communication, lead generation, customer support, appointment scheduling, workflow management, and operational processes using intelligent AI-powered systems.<br /><br />
                            Our AI automation services are designed to improve efficiency, reduce manual work, and increase business growth through smart automation technologies.
                        </p>
                    ...
                    <div className="hero-visual-complex">
                        {/* Minimalistic Dashboard Visual */}
                        <div className="comp-card main-dashboard">
                            <div className="md-header">
                                <div className="md-logo"><i className="fa-solid fa-robot"></i> Dashboard</div>
                                <div style={{ display: 'flex', gap: '10px', color: '#94a3b8' }}><i className="fa-solid fa-bell"></i> <i className="fa-solid fa-circle-user"></i></div>
                            </div>
                            <div className="md-body" style={{ display: 'grid', gridTemplateColumns: 'clamp(100px, 15vw, 160px) 1fr', height: 'calc(100% - 50px)' }}>
                                <div className="sidebar" style={{ borderRight: '1px solid rgba(255,255,255,0.05)', padding: '15px', display: 'flex', flexDirection: 'column', gap: '12px', fontSize: 'clamp(10px, 1vw, 12px)', color: '#94a3b8' }}>
                                    <div style={{ color: '#6366f1', fontWeight: '600', background: 'rgba(99,102,241,0.1)', padding: '8px', borderRadius: '6px' }}><i className="fa-solid fa-table-columns" style={{ marginRight: '8px' }}></i> Overview</div>
                                    <div><i className="fa-solid fa-comments" style={{ marginRight: '8px' }}></i> Conversations</div>
                                    <div><i className="fa-solid fa-users" style={{ marginRight: '8px' }}></i> Leads</div>
                                    <div><i className="fa-solid fa-calendar-check" style={{ marginRight: '8px' }}></i> Bookings</div>
                                    <div><i className="fa-solid fa-chart-line" style={{ marginRight: '8px' }}></i> Analytics</div>
                                </div>
                                <div className="main-content" style={{ padding: '20px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
                                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '10px' }}>
                                        <div style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)', padding: '10px', borderRadius: '10px' }}>
                                            <span style={{ fontSize: '9px', color: '#64748b', textTransform: 'uppercase' }}>Conversations</span>
                                            <div style={{ fontSize: 'clamp(14px, 1.5vw, 18px)', fontWeight: '700', margin: '5px 0' }}>12,543</div>
                                            <span style={{ fontSize: '9px', color: '#22c55e' }}><i className="fa-solid fa-caret-up"></i> +18.2%</span>
                                        </div>
                                        <div style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)', padding: '10px', borderRadius: '10px' }}>
                                            <span style={{ fontSize: '9px', color: '#64748b', textTransform: 'uppercase' }}>Leads Captured</span>
                                            <div style={{ fontSize: 'clamp(14px, 1.5vw, 18px)', fontWeight: '700', margin: '5px 0' }}>3,275</div>
                                            <span style={{ fontSize: '9px', color: '#22c55e' }}><i className="fa-solid fa-caret-up"></i> +22.6%</span>
                                        </div>
                                        <div style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)', padding: '10px', borderRadius: '10px' }}>
                                            <span style={{ fontSize: '9px', color: '#64748b', textTransform: 'uppercase' }}>Conversion Rate</span>
                                            <div style={{ fontSize: 'clamp(14px, 1.5vw, 18px)', fontWeight: '700', margin: '5px 0' }}>24.6%</div>
                                            <span style={{ fontSize: '9px', color: '#22c55e' }}><i className="fa-solid fa-caret-up"></i> +8.7%</span>
                                        </div>
                                    </div>
                                    {/* Small chart mock */}
                                    <div style={{ flex: '1', border: '1px solid rgba(255,255,255,0.05)', borderRadius: '12px', padding: '15px', background: 'rgba(0,0,0,0.2)', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '11px', color: '#94a3b8' }}>
                                            <span>Conversation Overview</span>
                                            <span style={{ fontSize: '9px', padding: '2px 8px', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '4px' }}>This Week</span>
                                        </div>
                                        <div style={{ height: '80px', marginTop: '10px' }}>
                                            <svg viewBox="0 0 300 80" width="100%" height="100%">
                                                <path d="M0,50 Q30,45 60,30 T120,35 T180,15 T240,40 T300,10" fill="none" stroke="#a855f7" strokeWidth="3" strokeLinecap="round"></path>
                                                <circle cx="180" cy="15" r="4" fill="#a855f7"></circle>
                                            </svg>
                                        </div>
                                    </div>
                                </div>
