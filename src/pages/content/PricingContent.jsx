        ...
        <div className="pricing-cards-grid">
          ...
          <div className="pricing-card-custom featured">
            ...
            <div className="pc-header">
              ...
              <div className="pc-price">₹24,999 <span>/mo</span></div>
            </div>
            <ul className="pc-features">
      ...
      <footer style={{ padding: '60px 0 30px', borderTop: '1px solid rgba(255,255,255,0.08)', background: '#050816', position: 'relative', zIndex: 10 }}>
        <div className="container">
          <div style={{ display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: '40px' }}>
            <div>
              <a href="/" className="logo" style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '12px' }}>
            ...
            <div style={{ display: 'flex', gap: '48px' }}>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                <h4 style={{ fontSize: '14px', color: 'white' }}>Platform</h4>
                <a href="/services" style={{ color: '#94a3b8', fontSize: '13px' }}>
                  Services
                </a>
                <a href="/pricing" style={{ color: '#94a3b8', fontSize: '13px' }}>
                  Pricing
                </a>
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                <h4 style={{ fontSize: '14px', color: 'white' }}>Company</h4>
                <a href="/contact" style={{ color: '#94a3b8', fontSize: '13px' }}>
                  Contact
                </a>
              </div>
            </div>
